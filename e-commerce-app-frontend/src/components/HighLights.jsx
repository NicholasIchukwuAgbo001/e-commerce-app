...
const Highlights = () => {
  return (
    <div className="flex gap-4 items-center justify-center text-sm relative">
      <div className="group relative flex items-center gap-1 hover:bg-stone-100 p-3 rounded-full cursor-pointer">
        <span>Shop</span>
      ...
      <div className="flex items-center gap-1 hover:bg-stone-100 py-3 px-5 rounded-full cursor-pointer relative group">
        <span>Sale</span>
      ...
      <div className="hover:bg-stone-100 p-3 rounded-full cursor-pointer relative group">
        <span>Brands</span>
        <div className="absolute top-full left-0 mt-2 w-48 bg-white border rounded-lg shadow-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-20">
          <ul className="py-2">
