const TopBar = () => {
  return (
    <div className="flex flex-col sm:flex-row justify-between items-center gap-4 px-4 py-1 bg-stone-950 text-sm">
      <div className="flex items-center gap-2 hover:bg-stone-600 p-2 cursor-pointer">
      ...
      <div className="flex items-center gap-2 hover:bg-stone-600 p-3 cursor-pointer">
